...
{    NewSubMenu('~F~ile', 0, NewMenu(
    ...
    NewSubMenu('~C~onfiguration', 0, NewMenu(
      NewItem('~S~ystem Settings','',kbNoKey,cmAscii,hcNoContext,
      NewItem('~A~gent Settings','',kbNoKey,cmWindow1,hcNoContext,
      Nil))),
...
begin
  MessageBox(#3'Mokarra - Configuration Tool'#13+ '(C)opyright 2011 LeafScale Systems'#13 +
    #3'(www.leafscale.com)',
